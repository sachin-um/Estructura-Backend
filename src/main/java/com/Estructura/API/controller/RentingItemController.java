...
public class RentingItemController {
    ...
    public ResponseEntity<RentingItem> RentingItem(
    ...
    public ResponseEntity<List<RentingItem>> getRentingItems(
    ...
    public GenericDeleteResponse<Long> deleteItem(
        ...
        ResponseEntity<RentingItem> item = rentingItemService.getItemById(
            itemId);
